...
console.log(item)
                  ...
                  x.push({
                    ...
                    graduation: childData.graduation,
                    college: childData.college,
  ...
  reset = (e) => {
    this.setState({ search_data: this.state.user_data, uname: "" });
  ...
  render() {
    const column = [
      ...
      { name: "Graduation", selector: "graduation" },
      { name: "College", selector: "college" },
    ...
    const body = this.state.search_data.map((item) => {
      ...
      return {
        ...
        btn: (<a
              style={{ color: "#fff" }}
              href={"/MentorClass/studentDetails?id=" + id}
            >
