...
import UserClassroom from "layouts/MentorClassroom.js";
var x = [];
let latestChat = "";
...
class Chatroom extends React.Component {
  ...
  componentDidMount() {
    ...
    this.setState({id:ID});
    // document.querySelector('.card').parentElement.parentElement.style.display='none';
          ...
          .then(() => {
            firebase
              ...
              .once("value", (snapshot) => {
                ...
                this.setState({ chatMsgsData: x , user_id: user.uid});
    ...
    if (
      ...
      firebase
        ...
        .set({
          ...
          msg_sender_name: this.state.userData.name,
          msg_time: msgSendTime,
          msg_id: msgId,
          msg_type: replyObj.msg_type,
          msg_sender_uid: this.state.userData.uid,
          msg_replied: "yes",
