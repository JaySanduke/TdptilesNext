...
this.toggleblock();      
  ...
  RemoveClass = (c_id, c_name) => {
    ...
    var newClassrooms = (this.state.classrooms.length > 0) ? this.state.classrooms.filter(item => item.c_id !== c_id) : [];
    ...
    return (
      <>
          ...
          <Card >
            <CardHeader style={{justifyContent : "space-between" , zIndex: "5"}} className="col-md-10 py-sm-3 mx-auto my-2  d-flex">
              <h1>
                ...
                <a
                    className="mb-3"
                    href={"/admin/EditQuiz?id=" + this.state.quiz_id}
                  >
                         ...
                         <Col lg="6">
                          <FormGroup>
                            ...
                            <Input
                              ...
                              type="text"
                              value={
                                this.state.block ? "Blocked" : "Unblocked"
                              }
                            />
                          </FormGroup>
                        </Col>
        ...
        <Modal isOpen={this.state.modal} toggle={this.toggle}>
          <ModalHeader toggle={this.toggle}>Add Quiz To Classroom</ModalHeader>
          <ModalBody>
            Assign The Quiz to Following Classrooms:
            <br />
            <Form
              role="form"
              className="mb-4"
