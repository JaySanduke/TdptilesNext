...
import Workshop from 'layouts/UserWorkshop.js';
              ...
              .then((snapshot) => {
                ...
                if (x) {
                  ...
                  document.getElementById("task_description").innerHTML =
                   ( x.data.w_details.Wdesc ?  x.data.w_details.Wdesc : "");
                }
    ...
    return (
      <div>
        ...
        <Container className="mt--7" fluid>
          <Card>
            <CardHeader className="m-2 d-flex text-center justify-content-center">
              <Row>
                <h1>Workshop: </h1>
            ...
            <CardBody className="px-2">
              {this.state.data.data && (
                <div className="col-md-9 py-sm-3 mx-auto">
                  {/* <span><h1>{this.state.data.data.w_details.workshopTitle}</h1></span>
                  <br />
                  <b>Subtitle :</b>{" "}
                  ...
                  {this.state.data.data.w_details.reg_end_date} <br />
                  <br />
