...
const Question = ({ data, numberOfQuestions, activeQuestion, onSetActiveQuestion, seenQues, onSetSeenQues, markedQues, onSetMarkedQues, second, userID }) => {
  ...
  useEffect(() => {
    ...
    firebase
      .database()
      .ref()
      .child("Responses/Workshop/" + classId + "/" + q_id + "/" + userID + "/" + activeQuestion + "/")
  ...
  return (
    <div className="card " id={`Q${data.id}`} style={{ height: "85vh", backgroundColor: "#deebf2" }}>
      ...
      <div className="card-content p-3">
        <div className="content">
          <h2 className="m-3 d-flex align-items-center quesPara">{activeQuestion + 1}. {ReactHtmlParser(data.question)}</h2>
          ...
          <div className='d-flex justify-content-end align-items-center'>
            <h3 id="buttonClear" onClick={clearBtn}>Clear</h3>
          </div>:null}
        </div>
      </div>
    </div>
